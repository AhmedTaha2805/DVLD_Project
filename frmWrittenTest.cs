...
namespace DVLD_project
{
    public partial class frmWrittenTest : Form
    {
        ...
        int Person_ID;
        int AppointID;
        public frmWrittenTest(int id, int Appointid = -1, bool Retake = false, int RTAppID = -1)
        {
            InitializeComponent();  
            AppointID = Appointid;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (IsDone)
            {
                ...
                MessageBox.Show($"Appointment Added Successfully with id = {TestApp.AppointmentID }", "Congratulations", MessageBoxButtons.OK);
            }
        }
    }
}
